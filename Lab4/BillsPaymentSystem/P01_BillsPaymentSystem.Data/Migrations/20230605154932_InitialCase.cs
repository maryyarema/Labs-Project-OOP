        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentMethods_BankAccountOrCreditCard", "((BankAccountId IS NULL AND CreditCardId IS NOT NULL) OR (BankAccountId IS NOT NULL AND CreditCardId IS NULL))");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1000.00m, "PrivateBank", "1000 0000 0000 0000" });

            migrationBuilder.InsertData(
                table: "CreditCards",
                columns: new[] { "CreditCardId", "ExpirationDate", "Limit", "MoneyOwed" },
                values: new object[] { 1, new DateTime(2022, 3, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 2500.00m, 500.00m });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Email", "FirstName", "LastName", "Password" },
                values: new object[] { 1, "first@gmail.com", "Tomas", "Shelby", "12345" });
